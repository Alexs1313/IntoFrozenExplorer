...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    overlay: require('../assets/froz-explrr-onboardimg1.png'),
  ...
  {
    background: require('../assets/froz-explrr-onboard-bg.png'),
    overlay: require('../assets/froz-explrr-onboardimg2.png'),
  ...
  {
    background: require('../assets/froz-explrr-onboard-bg.png'),
    overlay: require('../assets/froz-explrr-onboardimg3.png'),
  ...
  {
    background: require('../assets/froz-explrr-onboard-bg.png'),
    overlay: require('../assets/froz-explrr-onboardimg4.png'),
